sap.ui.define(
    ...
    Formatter.getObjectName = function(treeItem){
      if (this.hasOwnProperty("sParentAggregationName") && this.getBindingContext ) { //if the formatter is bound with the full-name, the control gets passed as the this-context
