...
module.exports = function(grunt) {
	...
	const oProjectConfig = grunt.file.exists(".project.json") ? grunt.file.readJSON(".project.json") : {};
	const oUserConfig = grunt.file.exists(".user.project.json") ? grunt.file.readJSON(".user.project.json") : {};
    ...
    //because you don't want to uplaod files of more than 15mb to an ABAP stack
		form = new multiparty.Form({ maxFilesSize: 1024 * 1024 * 15  });
